...
// @match          https://jira.fabit.ru/*
// @version        3.1
// @include        https://jira.fabit.ru/*
// @grant          none
// ==/UserScript==
...
var script = function () {
        ...
        var installUiStandard = function () {
                // There is no .toolbar-split-left in Jira 8 task ui
                // lib.$('.ops-menus .toolbar-split-left').append(ui.opsbar);
                lib.$('.ops-menus .aui-toolbar2-secondary').append(ui.opsbar);
        }
        ...
        var installUiLoop = function () {
                ...
                if (!isUiPresent()) {
                        if (context == 'issue') {
                                // Enable to log work for any user
